  ...
  export const gridItems = [
    {
      id: 5,
      title: "Featured",
      description: "[Instagram Feed Coming Soon]",
    ...
    },
    {
      ...
      description: "",  
      className: "lg:col-span-1  md:col-span-4 md:row-span-2 lg:row-span-2 lg:min-h-[60vh]",
      imgClassName: "absolute right-0 bottom-0 md:w-96 w-60",
      titleClassName: "justify-center md:justify-start lg:justify-center",
      img: "",
      spareImg: "/grid.svg",
    ...
    },
    {
      id: 4,
      title: "Follow us on:",
      description: "[Social Media Icons Coming Soon]",
